...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('scroll-left-nueva-categoria-1').addEventListener('click', function() {
        scrollLeft('nueva-categoria-1');
    });
    document.getElementById('scroll-right-nueva-categoria-1').addEventListener('click', function() {
        scrollRight('nueva-categoria-1');
    });
